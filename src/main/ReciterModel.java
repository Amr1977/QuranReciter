...
public class ReciterModel {
    ...
    public static int downloadAhead = 4;
                ...
                for (String s : lines) {
                    ...
                    switch (terms[0]) {
                        case "speech":
                            ...
                            break;
                        case "download_ahead_count":
                            downloadAheadLength = Integer.valueOf(terms[1]);
                            break;
                        case "reciter":
    ...
    public static Verse getVerseAhead(int currentSura, int currentAya, int count) {
        if ((count + currentAya) <= ayatCount[currentSura]) {
            return new Verse(currentSura, (currentAya + count));
        } else {
            int nextSura = ((currentSura + 1) <= 114 ? (currentSura + 1) : (1));
